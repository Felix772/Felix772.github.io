...
# Felix Hao
Computer Science student at the University of Florida (Class of 2028), interested in low-latency systems, backend infrastructure, and quantitative trading systems.
Completed secondary education at Beijing No. 4 High School.
Currently focused on building high-performance systems in C++ and understanding the design of modern electronic trading infrastructure.
...
- Built an **information diffusion research model** that maps timestamped earnings-call events to high-frequency market response across AMD, NVIDIA, TSLA, COIN, and CRWD acquired-data runs
